...
B -->|Stores Cleaned Articles| C[(🧩 MongoDB Database)]
B -->|Performs| D[🧠 Sentiment & Category Analysis]
B -->|Generates| E[🗞️ AI Summaries]
C -->|Feeds Data To| F[💻 React Frontend Dashboard]
